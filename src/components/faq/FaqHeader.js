...
function FaqHeader() {
  return (
    <section id="faq-header" className="w-full h-full flex justify-center">
      <div className="max-w-screen-2xl w-full xs:px-10 md:px-0 pt-32 xs:pb-16 md:pb-24 flex justify-between items-center gap-12 xs:text-center md:text-left">
        <div className="xs:w-full md:w-1/2 h-full flex flex-col justify-center xs:items-center md:items-start md:pl-10">
          ...
          <p className="w-3/4 xs:text-sm md:text-base text-gray-900">
            Still curious and have lots of questions on your head? Worry not, we
            got you!
          </p>
        </div>
