      ...
      <div className="max-w-screen-2xl w-full px-10 py-16 text-center">
        <div className="xs:mb-12 md:mb-24 flex justify-center">
          <div className="xs:w-full md:w-120">
            <h2 className="xs:text-3xl md:text-4xl lg:text-5xl text-gray-900 font-semibold xs:mb-5 lg:mb-10">
          ...
          {achievementsData.map((achievement) => {
            return (
              <div key={achievement.id}>
                <span className="xs:text-5xl md:text-6xl font-semibold text-gray-900 mb-8 inline-block">
